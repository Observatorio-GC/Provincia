...
function agregarPopupdepartamentos(feature, layer) {
    if (feature.properties && feature.properties.NOMBRE) {
        layer.bindPopup("<strong>" + feature.properties.NOMBRE);
    }
}
...
function agregarPopupeducacion(feature, layer) {
    if (feature.properties && feature.properties.NOMBRE) {
        layer.bindPopup("<strong>" + feature.properties.NOMBRE + "</strong><br/>" + feature.properties.REGION + "</strong><br/>" + feature.properties.CARGO);
    }
}
...
function agregarPopupSeguridad(feature, layer) {
    if (feature.properties && feature.properties.ZONAS) {
        layer.bindPopup("<strong>" + feature.properties.ZONAS + "</strong><br/>" + feature.properties.MUNICIPIO + "</strong><br/>");
    }
}

function agregarPopupCentros(feature, layer) {
    if (feature.properties && feature.properties.NOMBRE) {
        layer.bindPopup("<strong>" + feature.properties.NOMBRE + "</strong><br/>" + feature.properties.DEPARTAMENTO + "</strong><br/>");
    }
}
...
function estilojudicial() {
    judicial.eachLayer(function (featureInstanceLayer) {
        var id_feature = featureInstanceLayer.feature.properties['id'];
        if (id_feature == 1) {
            color_actual = '#e31a1c';
        }else if (id_feature == 2) {
        ...
        featureInstanceLayer.setStyle({
            color: color_actual, fillOpacity: 0.50, weight: 3
        });
    });
}
...
function estilodistritos() {
    distritos.eachLayer(function (featureInstanceLayer) {
        var id_feature = featureInstanceLayer.feature.properties['id'];
        if (id_feature == 1) {
            color_actual = '#3336ff';
        }else if (id_feature == 2) {
...
function estilovialidad() {
    vialidad.eachLayer(function (featureInstanceLayer) {
        var id_feature = featureInstanceLayer.feature.properties['id'];
        if (id_feature == 1) {
            color_actual = '#e31a1c';
        }else if (id_feature == 2) {
        ...
        var optiones_textura = { height: 10, weight: 4, spaceWeight: 4, color: color_actual, spaceColor: color_actual, spaceOpacity: 0.3, angle: -145 };
        var textura_vialidad = new L.StripePattern(optiones_textura); textura_vialidad.addTo(map);

        featureInstanceLayer.setStyle({
            color: color_actual, fillOpacity: 0.75, fillPattern: textura_vialidad
        });
    });
}


function estiloirrigacion() {
    irrigacion.eachLayer(function (featureInstanceLayer) {
        var id_feature = featureInstanceLayer.feature.properties['id'];
        if (id_feature == 1) {
            color_actual = '#0fb4bf';
        }else if (id_feature == 2) {
        ...
        var optiones_textura = { height: 10, weight: 4, spaceWeight: 4, color: color_actual, spaceColor: color_actual, spaceOpacity: 0.3, angle: -45 };
        var textura_irrigacion = new L.StripePattern(optiones_textura); textura_irrigacion.addTo(map);

        featureInstanceLayer.setStyle({
            color: color_actual, fillOpacity: 0.75, fillPattern: textura_irrigacion
        });
    });
}

function estilosalud() {
    salud.eachLayer(function (featureInstanceLayer) {
        var id_feature = featureInstanceLayer.feature.properties['id'];
        if (id_feature == 1) {
            color_actual = '#e31a1c';
        }else if (id_feature == 2) {
        ...
        var optiones_textura = { height: 10, weight: 4, spaceWeight: 4, color: color_actual, spaceColor: color_actual, spaceOpacity: 0.3, angle: -90 };
        var textura_salud = new L.StripePattern(optiones_textura); textura_salud.addTo(map);

        featureInstanceLayer.setStyle({
            color: color_actual, fillOpacity: 0.5, fillPattern: textura_salud
        });
    });
}


function estiloeducacion() {
    educacion.eachLayer(function (featureInstanceLayer) {
        var id_feature = featureInstanceLayer.feature.properties['ZONAS'];
        if (id_feature == 1) {
            color_actual = '#336bff';
        }else if (id_feature == 2) {
            color_actual = '#ff3364';
        ...
        featureInstanceLayer.setStyle({
            color: color_actual, fillOpacity: 0.30, weight: 3
        });
    });
}

function estiloseguridad() {
    seguridad.eachLayer(function (featureInstanceLayer) {
        var id_feature = featureInstanceLayer.feature.properties['id'];
        if (id_feature == 1) {
            color_actual = '#e31a1c';
        }else if (id_feature == 2) {
        ...
        var optiones_textura = { height: 5, weight: 4, spaceWeight: 4, color: color_actual, spaceColor: color_actual, spaceOpacity: 0.3, angle: -90 };
        var textura_salud = new L.StripePattern(optiones_textura); textura_salud.addTo(map);
